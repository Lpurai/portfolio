...
return(
  <>   
      ...
      project &&
      (<>
      <div id="mainContent-div" className="flex flex-col space-y-3  h-screen mt-16 ml-31">
      <h1>{project.title}.</h1>
      <p>{project.description}</p>
      <div className="flex flex-col space-y-10 lg:flex-row  lg:space-x-20">
        <div className="flex flex-col space-y-3 ml-10 pr-100">
     ...
     <div className=" flex flex-col  lg:flex-row shadow-lg">
       ...
       <div className="p-5">
        ...
        <div className="flex flex-col space-y-5 pt-3 h-screen mt-16 ml-31">
         ...
         <p className="flex "> <Lightbulb  size={30}/>Every great project starts with an idea. Select one to see the execution.</p>
          <section className="flex flex-col space-y-10 items-center justify-center bg-background w-1/2 justify-center ml-50 p-10 shadow-lg">
            <Section
